...
const envSchema = z.object({
  ...
  ROLE_RESPONSABLE_LORE: z.preprocess(emptyToUndefined, z.string().optional().default('1324443544311562290')),
  ...
  ROLE_LORE: z.preprocess(emptyToUndefined, z.string().optional().default('1324443462061522974')),
