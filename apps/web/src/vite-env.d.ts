...
interface ImportMetaEnv {
  ...
  readonly VITE_DISCORD_ROLE_RESPONSABLE_MJ: string
  readonly VITE_DISCORD_ROLE_RESPONSABLE_LORE: string
  ...
  readonly VITE_DISCORD_ROLE_MJ_SENIOR: string
  readonly VITE_DISCORD_ROLE_LORE: string
