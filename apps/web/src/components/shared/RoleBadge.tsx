...
const ROLE_STYLES: Record<StaffRoleKey, string> = {
  ...
  responsable_lore: 'bg-amber-500/15 text-amber-400 border-amber-500/25',
  responsable_bdm: 'bg-cyan-500/15 text-cyan-400 border-cyan-500/25',
  ...
  lore: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/25',
  bdm: 'bg-cyan-500/15 text-cyan-400 border-cyan-500/25',
}
