...
import {
  ...
  Calendar, Clock, Sword, Edit2, ExternalLink,
} from 'lucide-react'
import { toast } from 'sonner'
import { useMyReports, useUserReports } from '@/hooks/queries/useAnimations'
...
export function ReportRow({ report, onClick }: { report: AnimationReport; onClick: () => void }) {
